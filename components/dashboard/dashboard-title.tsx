...
const DashboardTitle = () => {
  ...
  return (
    <div className="flex flex-col self-stretch items-start py-7 space-y-7 ">
      <div className="flex justify-between self-stretch items-start w-full">
        <div className="flex items-center space-x-4">
          <h1 className="text-[34px] leading-[117.647%] font-bold  -tracking-[0.68px] text-secondary">
            Wallet Ledger
            <button
              type="button"
              onClick={toggleCaret}
        ...
        <div className="flex gap-3 flex-start">
          <button
            type="button"
            className="flex items-center justify-center bg-[#4B8B9F] text-[#020303] px-[18px] py-2 rounded-2xl cursor-pointer text-[15px] font-medium leading-[133.333%]"
          >
            Share
          </button>
          <button
            type="button"
            className="flex p-2 items-center justify-center rounded-2xl bg-inherit border-[1.5px] border-[#49656E33] "
          >
            {""}
            <svg
      ...
      <div className="flex space-x-3 items-center">
        ...
        <p className=" text-[15px] leading-[133.333%] -tracking-[0.075px] text-[#15272D9E] " >Ava, Liam, Noah<span className="ml-1" >+12 others</span></p>
      </div>
      <div className="flex items-start self-stretch border-b-[1.5px] border-[#49656E33] " >
        <button
          type="button"
          onClick={() => tabHandler("")}
          className={` px-7 py-3 text-center text-[15px] font-medium leading-[133.333%] cursor-pointer hover:bg-primary-16 transition-colors  ${tab === "" ? "text-primary border-b-[1.5px]  border-[#4B8B9F]" : "text-[#15272D9E]"}`}
        >
          Overview
        </button>
        <button
          ...
          className={` px-7 py-3 text-center text-[15px] font-medium leading-[133.333%]  cursor-pointer hover:bg-primary-16 transition-colors ${tab === "transactions" ? "text-primary border-b-[1.5px]  border-[#4B8B9F]" : "text-[#15272D9E]"}`}
        >
          Transactions
        </button>
      </div>
